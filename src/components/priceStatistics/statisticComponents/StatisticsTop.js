  ...
  return (
    <div className="statistics__header">
      ...
      <div className="statistics__header__body">
        <h2 className="statistics__header__body--title">Price Statistics</h2>

        <div className="statistics__header__body_graph">
          <div>
            <img src={line1} />
            <h4 className="statistics__header__body_graph_name statistics__header__body_graph_name--light">
              Q1
            </h4>
          </div>
          <div>
          ...
          <div>
            <img src={line4} />
            <h4 className="statistics__header__body_graph_name statistics__header__body_graph_name--bold">
              2018
            </h4>
          </div>
          <div>
      ...
      <div className="statistics__header__media">
        <img src={fuelPump} />
        <p className="statistics__header__media_summary">
          Find the best gas prices in your state to maximize savings at the
          pump.
        </p>
        <button className="statistics__header__media_btn statistics__header__media_btn--primary">Find</button>
      </div>
    </div>
  );
};
